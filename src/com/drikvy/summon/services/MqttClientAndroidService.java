...
============================================================================
 */
package com.drikvy.summon.services;
...
public class MqttClientAndroidService extends BroadcastReceiver implements
  ...
  private static final String SERVICE_NAME = "com.drikvy.summon.services.MqttService";
  ...
  private final class MyServiceConnection implements ServiceConnection {
    ...
    public void onServiceConnected(ComponentName name, IBinder binder) {
      ...
      Log.v("MqttService", "Service is CONNECTED!!!");
  ...
  public MqttClientAndroidService(Context context, String serverURI,
	  ...
	  Log.v("MqttService", "initialize client service");
    myContext = context;
  ...
  public IMqttToken connect(MqttConnectOptions options, Object userContext,
    ...
    if (mqttService == null) { // First time - must bind to the service
    	Log.v("MqttService", "Service is NULL");
  ...
  public IMqttToken subscribe(String topic, int qos, Object userContext,
    ...
    String activityToken = storeToken(token);
    if(mqttService != null) {
    	Log.v("MqttService", "Service is NOT NULL!!!");
